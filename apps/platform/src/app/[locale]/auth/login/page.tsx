  ...
  return (
    <div className="flex text-white w-full items-center justify-center ">
      <div className="flex flex-col md:flex-row items-center justify-center gap-4">
        <h1 className="mb-8 text-4xl font-bold animate-pulseGrow"> E-Class </h1>
        <div className="space-y-4 animate-fade-in transform rounded-md border border-gray-300 p-6 shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg">
          {loggedOut && (
