...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="flex flex-col  text-base-neutral-50 gap-4 mt-3 items-center justify-center text-center">
      ...
      <ProfileInfo  locale={props.locale as TLocale} />
      <ProfessionalInfo locale={props.locale as TLocale} />
      <ProfileTabs initialProfiles={mockProfiles} locale={props.locale as TLocale}/>
    </div>
  );
}
