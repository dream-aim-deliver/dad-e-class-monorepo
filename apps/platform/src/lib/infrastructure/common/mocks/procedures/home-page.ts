...
const accordionMockData: homePage.TAccordionItem[] = [
    {
        title: 'Matching',
        ...
        content: JSON.stringify([
            ...
            },
            {
                ...
                children: [
                    {
                        type: 'list-item',
                        children: [{ text: 'Schritt-für-Schritt Anleitung' }],
                    },
                    {
                        type: 'list-item',
                        children: [
        ...
        content: JSON.stringify([
            ...
            },
            {
                ...
                children: [
                    {
                        type: 'list-item',
                        children: [{ text: 'Automated workflow management' }],
                    },
                    {
                        type: 'list-item',
                        children: [{ text: 'Real-time collaboration tools' }],
                    },
                    {
                        type: 'list-item',
