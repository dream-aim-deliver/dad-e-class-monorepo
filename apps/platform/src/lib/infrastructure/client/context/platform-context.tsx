 ...
 * This provides platform information (name, logo, background image, footer, etc.) to child components.
 */
 ...
 * Returns null if not within a platform context or if platform hasn't been loaded.
 *
 * @example
 * ```tsx
 ...
 *   console.log('Background:', platformContext.platform.backgroundImageUrl);
 * }
 * ```
 */
