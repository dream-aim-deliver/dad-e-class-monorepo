                ...
                <div className="bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-700">
                    <div className="bg-gray-900 px-6 py-8 border-b border-gray-700">
                        ...
                        <div className="flex items-center text-gray-300">
                            ...
                            Current locale:{' '}
                            <span className="font-semibold ml-1 text-gray-100">
                                {locale}
                            </span>
                        </div>
                    </div>
                            ...
                            <div className="flex items-center mb-4">
                                <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center mr-3">
                                    ...
                                    >
                                        <path
                                            fillRule="evenodd"
                                            d="M18 8a6 6 0 01-7.743 5.743L10 14l-2 1-1 1H6a2 2 0 01-2-2v-1l4.257-4.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z"
                                            clipRule="evenodd"
                                        />
                                    </svg>
                                </div>
                        ...
                        <div className="bg-gray-700 rounded-xl p-6 border border-gray-600">
                            ...
                            <div className="bg-gray-800 rounded-lg border border-gray-600 p-4 overflow-x-auto">
                                <pre className="text-sm text-gray-300 font-mono">
                                    {JSON.stringify(cmsVersion, null, 2)}
                                </pre>
                            </div>
                        </div>
