...
// TODO: Please change upload type as per your usecase
// type GroupNotesUploadType = "upload_group_note_icon";
type GroupNotesUploadType = "upload_home_page_accordion_item";
    ...
    const uploadFile = async (
        ...
        const uploadResult = await requestFileUploadMutation.mutateAsync({
            upload: {
                ...
                // TODO: please uncomment and pass groupId once backend supports it
                // groupId: groupId,
            }
        });
