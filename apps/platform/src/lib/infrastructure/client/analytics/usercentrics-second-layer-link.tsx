...
/**
 * Minimal shape of the Usercentrics CMP v3 Web API we rely on here.
 * The full interface is declared in `usercentrics-adapter.ts`; we only
 * need `showSecondLayer` for this component.
 */
