...
export const DE: TDictionary = {
  components: {
    ...
    availableCoachingSessions: {
      title: 'Verfügbare Coaching-Sessions',
      buyMoreSessions: 'Kaufen Sie mehr Sessions',
      durationMinutes: 'Minuten',
      loadingText: 'Sessions werden geladen...',
      noAvailableSessionText: 'Keine verfügbaren Sessions',
    },
    coachReview:{
      by:'von'
    },
    ...
    buyCoachingSession: {
      title: "Coaching-Session kaufen",
      description: "Plane deine Sessions jederzeit mit deinem Lieblingscoach.",
      buttonText: "Coaching-Sessions kaufen",
      total: "Gesamt",
      minutes: "Minuten"
    },
    videoPlayer: {
    ...
    coachingSessionCard: {
      ...
      courseText: 'Kurs',
      groupText: 'Gruppe',
      joinMeetingText: 'Session beitreten',
      ...
      meetingLinkVisibilityInfo:
        'Der Meeting-Link wird 10 Minuten vor der Session sichtbar sein',
      reviewCoachingSessionText: 'Rückblick auf die Coaching-Session',
      ...
      sessionCanceledText: 'Session abgebrochen',
    ...
    coachingSessionTracker: {
      minuteText: 'Minuten',
      usedText: 'gebraucht',
      buyMoreSessionsText: 'Kaufen Sie weitere Sessions',
      buyCoachingSessionsText: 'Coaching-Sessions kaufen',
      coachingSessionText: 'Coaching-Sessions inklusive',
      noCoachingSessionText: 'Keine Coaching-Sessions enthalten',
    },
    courseProgressBar: {
