...
export const DE: TDictionary = {
  ...
  components: {
    ...
    coachingSession: {
      ...
      rateCallQuality: 'Bewerten Sie die Anrufqualität',
      sessionCanceled: 'Sitzung abgebrochen',
      decline: 'Abfall',
      accept: 'Akzeptieren',
      suggestAnotherDate: 'Schlagen Sie einen anderen Termin vor',
      joinMeeting: 'Treten Sie der Besprechung bei',
      requestSent: 'Anfrage gesendet',
      cancelRequest: 'Anfrage abbrechen',
      hoursLeftToEdit:
        'Es verbleiben noch 2 Stunden, um das Ereignis zu bearbeiten',
