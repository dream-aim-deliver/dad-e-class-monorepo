...
export const DE: TDictionary = {
  components: {
    ...
    courseCard: {
      ...
      sales: 'Verkäufe',
      hours: 'Stunden',
      includeCourseButton: 'Hinzufügen',
      excludeCourseButton: 'Entfernen',
    ...
    professionalInfo: {
      ...
      linkedinPlaceholder: 'z. B. https://www.linkedin.com/in/ihrprofil',

      curriculumVitae: 'Lebenslauf (CV)',
      cvRequired: 'Lebenslauf ist erforderlich',
      portfolioWebsite: 'Portfolio-Webseite-URL (optional)',
      portfolioWebsitePlaceholder: 'z. B. https://www.ihrportfolio.com',
    ...
    coachingSessionCard: {
      ...
      reviewsSentText: 'Bewertung(en) gesendet:',
      ...
      yourCoachText: 'Dein Coach',
      studentRoleTooltip: 'Du wirst in dieser Sitzung gecoacht',
    },
    ...
    lessonHeader: {
      ...
      copyLinkToLesson: 'Link zur Lektion kopieren',
    ...
    certificateGenerator: {
      ...
      certifyThat: 'Dieses Zertifikat erhält',
    ...
    link: {
      ...
      urlPlaceholder: 'Z.B. https://example.com/dies/ist/die/url',
    ...
    studentCard: {
      coachingSessionsLeftText: 'Coaching-Sitzung(en)',
      coach: 'Coach',
      course: 'Kurs',
    ...
    coachStudentInteractionCard: {
      ...
      oneOutOfThree: 'Eins aus drei',
      uploadFiles: 'Datei-Upload',
    ...
    addTransactionModal: {
      ...
      invoiceUrlPlaceholder: 'z.B. https://example.com/invoices/?id=12345',
      tagsLabel: 'Tags',
  ...
  pages: {
    ...
    calendarPage: {
      ...
      coachLabel: 'Dein Coach',
      groupLabel: 'Gruppe',
      courseLabel: 'Kurs',
      platformLabel: 'Plattform',
      studentRoleLabel: 'Du wirst in dieser Sitzung gecoacht',
    ...
    singleUser: {
      ...
      doNotSendEmails: 'Keine E-Mails an diesen Benutzer senden',
