...
export const EN: TDictionary = {
  components: {
    ...
    courseCard: {
      ...
      availableCoachingSession: 'Available Coaching Sessions',
    ...
    courseMaterialsAccordion: {
      ...
      moduleTooltip: 'Only modules with materials are shown. The number reflects the original position in the course.',
      lessonTooltip: 'Only lessons with materials are shown. The number reflects the original position in the module.',
