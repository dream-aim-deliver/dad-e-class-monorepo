...
export const EN: TDictionary = {
  components: {
    ...
    courseCard: {
      ...
      cochingSession: 'Total Coaching Session(s)',
      cochingSessionHint: 'This is the total number of coaching sessions that are part of this course. It does not reflect how many you have already purchased or how many are still available to book.',
      availableCoachingSession: 'Available Coaching Session(s)',
      availableCoachingSessionHint: 'The number of coaching sessions available for you to book in this course.',
      sale: 'sale',
      sales: 'sales',
      hours: 'hours',
      ...
      savingsWithCoachingTooltip: 'Your savings when purchasing with coaching included',
    },
    reviewModal: {
    ...
    coachingSessionCard: {
      ...
      yourCoachText: 'Your coach',
      studentRoleTooltip: "You're being coached in this session",
    },
    ...
    studentCard: {
      coachingSessionsLeftText: 'coaching session(s)',
      coach: 'Coach',
      course: 'Course',
      waitingFeedbackBadge: 'Waiting for feedback',
      longWaitBadge: 'Waited for more than 48h',
      assignmentPassedBadge: 'Assignment Passed',
    ...
    coachNotes: {
      ...
      notesValidation: "This group has no coach yet. A coach will be assigned soon.",
      customIcon: "custom icon",
    ...
    breadcrumbs: {
      ...
      calendar: "Calendar",
      groupCoachingCalendar: "Group Coaching Calendar",
    ...
    courseMaterialsAccordion: {
      ...
      moduleLabel: 'Module %{position} of %{total}',
      lessonLabel: 'Lesson %{position} of %{total}',
    ...
    packagePricingStep: {
      ...
      completePackageDescription: 'Set the total price for students who purchase all courses in this package. The "with coaching" price includes coaching sessions, while the "without coaching" price is for course access only.',
      ...
      partialDiscountsDescription: 'When a student purchases only some of the courses in this package (instead of the full bundle), you can offer them a percentage discount compared to buying each course individually. This discount applies regardless of whether they include coaching or not.',
      partialDiscountsVisibilityNote: 'Note: Discount slots only appear for packages with 3 or more courses, and only up to one less than the total. For example: a package with 2 courses shows no discount slots (buying both = complete package price, buying 1 = individual course price). A package with 3 courses shows one slot (for 2 courses), since buying all 3 is the complete package and buying 1 is the individual price. A package with 5 courses shows slots for 2, 3, and 4 courses. In general: buying all courses always uses the complete package price above, and buying a single course uses that course\'s individual price — neither needs a discount slot.',
    ...
    orderHistoryCard: {
      ...
      courseWithCoaching: 'Course (with coaching)',
      coachingSessionsIncluded: 'coaching session(s) included',
      at: 'at',
      invoice: 'Invoice (PDF)',
      total: 'Tot:',
  ...
  pages: {
    ...
    course: {
      ...
      visitor: {
        ...
        alsoIncludedDescription: 'Learn more while saving. You can get this course included in the following packages:',
    ...
    student: {
      ...
      noAssessmentFound: 'No pre-course assessment found',
    ...
    coachCoachingSessions: {
      ...
      declineReasonPlaceholder: "Enter your reason for declining...",
      decline: "Decline",
      roleCoach: "Coach",
      roleStudent: "Student",
    ...
    profile: {
      ...
      usernameInvalid: 'Username must be lowercase letters, numbers, and hyphens only (no uppercase, no underscores, no spaces, no leading/trailing hyphens)',
    ...
    studentCoachingSessions: {
      yourCoachingSessions: 'Scheduled Coaching Sessions',
      upcoming: 'Upcoming',
      ended: 'Ended',
      available: 'Available',
      availableSessionsDescription: 'Participate in group coaching or book a 1:1 session with your coach.',
      noCoachesFound: "You don't have any past coaches yet",
      noCoachesDescription: 'Start by exploring available coaches and booking your first session.',
      exploreCoaches: 'Explore our coaches',
      yourPastCoaches: 'Your past coaches',
      viewAllCoaches: 'View all coaches',
      noSessionsFound: 'You have no sessions yet.',
    ...
    userDashboard: {
      ...
      coupon: {
        ...
        packageCoursesCount: "Package with {count} courses",
      },
    },
    notifications: {
      error: {
    ...
    userCoachingSessions: {
      ...
      loadingTitle: "Scheduled Coaching Sessions",
    ...
    orderHistory: {
      ...
      fieldCompanyAddress: 'Company Address',
      fieldCompanyUuid: 'Company UID/VAT',
      ...
      customerDataMissing: 'Your profile information is required to generate invoices. Please update your profile.',
      fieldFirstName: 'First Name',
      fieldSurname: 'Surname',
      customerDataFetchFailed: 'Unable to load your profile information. PDF generation is not available. Please complete your personal profile and try again.',
    ...
    calendarPage: {
      ...
      weeklyView: 'Weekly',
      monthlyView: 'Monthly',
      groupCoachingTab: 'Group Coaching',
      groupCoachingTitle: 'Group Coaching Sessions Calendar',
      addGroupSessionButton: 'Add Group Session',
      addingGroupSession: 'Adding group session...',
      groupCoachingOfferings: 'Coaching Offerings',
      selectCoachingOffering: 'Select a coaching offering',
      ...
      studentRoleLabel: "You're being coached in this session",
    ...
    singleUser: {
      ...
      backToUsers: 'Back to Platform Users',
      personalProfile: 'Personal Profile',
      professionalProfile: 'Professional Profile',
      studentCourses: 'Enrolled Courses',
      coachCourses: 'Teaching Courses',
      coachReviews: 'Coach Reviews',
      roles: 'Roles',
      changeRole: 'Change Role',
      confirmRoleChangeTitle: 'Confirm Role Change',
      confirmRoleChangeMessage: 'Are you sure you want to change this user\'s role to {role}? This action will modify the user\'s permissions.',
      confirmButton: 'Confirm',
      updatingButton: 'Updating...',
      roleUpdateSuccess: 'Role successfully updated to {role}',
      ...
      portfolioWebsite: 'Portfolio Website',
      professionalCompanyInfo: 'Company Information',
      companyRole: 'Role',
      ...
      doNotSendEmails: "Don't send emails to this user",
      noPersonalProfile: 'This user has not created a personal profile yet.',
      coachApplication: {
        title: 'Coach Application',
        helperText: 'This student has submitted a coach application for you to review.',
        submittedOn: 'Submitted on',
        status: 'Status',
        statusPending: 'Pending Review',
        statusApproved: 'Approved',
        statusRejected: 'Rejected',
        submittedProfile: 'Submitted Professional Profile',
        cv: 'CV',
