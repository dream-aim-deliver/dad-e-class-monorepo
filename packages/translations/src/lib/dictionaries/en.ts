...
export const EN: TDictionary = {
  components: {
    ...
    assignmentGridFilterModal: {
      ...
      dateFromLabel: 'From',
      dateToLabel: 'To',
      hasFilesLabel: 'Has Files',
      hasLinksLabel: 'Has Links',
      hasRepliesLabel: 'Has Replies',
      resetFilters: 'Reset',
      applyFilters: 'Apply',
    },
    assignmentCardList: {
...
=======
    ...
    assignment: {
      ...
      assignmentBuilder: {
        ...
        descriptionPlaceholderText: "Please download the file, follow the tasks and upload your work when you're done.",
        addResourcesText: 'Add resources',
>>>>>>> c1df73f (feat(ui-kit): Assignment components (CreateAssingment , BuilderView , ReplyPanel , Message , AssignmentCard and AssingmentModel) UI is added with storybook and testing.)
      },
    },
  },
  pages: {
