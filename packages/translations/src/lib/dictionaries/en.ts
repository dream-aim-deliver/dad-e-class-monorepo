...
export const EN: TDictionary = {
  components: {
    ...
    removeModal: {
      ...
      deleteButton: 'Delete',
      closeButton: 'Close',
      errorMessageCoach: 'Unable to remove coach. Please try again or check you connection.',
      errorMessageLesson: 'Unable to delete lesson. Please try again or check you connection.',
      errorMessageModule: 'Unable to delete module. Please try again or check you connection.',
