...
import { IconEyeHide } from '../../lib/components/icons/icon-eye-hide';

// Meta configuration for Storybook
const meta: Meta<typeof IconEyeHide> = {
  title: 'Icons/IconEyeHide',
  component: IconEyeHide,
  tags: ['autodocs'],
  argTypes: {
    size: {
      control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconEyeHide>;
