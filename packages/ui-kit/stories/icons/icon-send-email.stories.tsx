...
import { IconSendEmail } from '../../lib/components/icons/icon-send-email';

// Meta configuration for Storybook
const meta: Meta<typeof IconSendEmail> = {
    title: 'Icons/IconSendEmail',
    component: IconSendEmail,
    tags: ['autodocs'],
    argTypes: {
        size: {
            control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconSendEmail>;
