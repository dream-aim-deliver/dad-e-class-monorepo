...
import { IconRichText } from '../../lib/components/icons/icon-rich-text';

// Meta configuration for Storybook
const meta: Meta<typeof IconRichText> = {
  title: 'Icons/IconRichText',
  component: IconRichText,
  tags: ['autodocs'],
  argTypes: {
    size: {
      control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconRichText>;
