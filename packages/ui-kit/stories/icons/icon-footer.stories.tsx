...
import { IconFooter } from '../../lib/components/icons/icon-footer';

// Meta configuration for Storybook
const meta: Meta<typeof IconFooter> = {
    title: 'Icons/IconFooter',
    component: IconFooter,
    tags: ['autodocs'],
    argTypes: {
        size: {
            control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconFooter>;
