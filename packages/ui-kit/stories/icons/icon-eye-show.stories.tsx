...
import { IconEyeShow } from '../../lib/components/icons/icon-eye-show';

// Meta configuration for Storybook
const meta: Meta<typeof IconEyeShow> = {
  title: 'Icons/IconEyeShow',
  component: IconEyeShow,
  tags: ['autodocs'],
  argTypes: {
    size: {
      control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconEyeShow>;
