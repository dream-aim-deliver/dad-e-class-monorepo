...
const meta: Meta<typeof IconCalendarAvailability> = {
  title: 'Icons/IconCalendarAvailability',
  component: IconCalendarAvailability,
  tags: ['autodocs'],
  argTypes: {
    size: {
      control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconCalendarAvailability>;
