...
import { IconMultiChoice } from '../../lib/components/icons/icon-multi-choice';

// Meta configuration for Storybook
const meta: Meta<typeof IconMultiChoice> = {
  title: 'Icons/IconMultiChoice',
  component:IconMultiChoice,
  tags: ['autodocs'],
  argTypes: {
    size: {
      control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconMultiChoice>;
