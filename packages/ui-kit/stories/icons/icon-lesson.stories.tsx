...
import { IconLesson } from '../../lib/components/icons/icon-lesson';

// Meta configuration for Storybook
const meta: Meta<typeof IconLesson> = {
  title: 'Icons/IconLesson',
  component: IconLesson,
  tags: ['autodocs'],
  argTypes: {
    size: {
      control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconLesson>;
