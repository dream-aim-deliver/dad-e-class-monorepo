...
import { IconCheckDouble } from '../../lib/components/icons/icon-check-double';

// Meta configuration for Storybook
const meta: Meta<typeof IconCheckDouble> = {
  title: 'Icons/IconCheckDouble',
  component: IconCheckDouble,
  tags: ['autodocs'],
  argTypes: {
    size: {
      control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconCheckDouble>;
