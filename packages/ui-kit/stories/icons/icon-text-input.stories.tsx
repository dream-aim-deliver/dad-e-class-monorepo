...
import { IconTextInput } from '../../lib/components/icons/icon-text-input';

// Meta configuration for Storybook
const meta: Meta<typeof IconTextInput> = {
  title: 'Icons/IconTextInput',
...
export default meta;
type Story = StoryObj<typeof IconTextInput>;
