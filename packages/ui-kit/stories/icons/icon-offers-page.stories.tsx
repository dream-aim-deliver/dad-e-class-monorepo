...
import { IconOffersPage } from '../../lib/components/icons/icon-offers-page';

// Meta configuration for Storybook
const meta: Meta<typeof IconOffersPage> = {
    title: 'Icons/IconOffersPage',
    component: IconOffersPage,
    tags: ['autodocs'],
    argTypes: {
        size: {
            control: { type: 'number' },
...
export default meta;
type Story = StoryObj<typeof IconOffersPage>;
