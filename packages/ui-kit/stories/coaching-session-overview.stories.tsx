...
import { UserType } from '../lib/components/coaching-sessions/coaching-sessions';

const meta: Meta<typeof CoachingSessionOverview> = {
  title: 'Components/CoachingSessionComponents/CoachingSessionOverview',
...
export default meta;
type Story = StoryObj<typeof CoachingSessionOverview>;
