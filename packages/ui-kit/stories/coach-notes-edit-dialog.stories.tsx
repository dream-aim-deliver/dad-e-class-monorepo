...
const CoachNotesEditDialogWrapper = ({
  ...
  const handleImageChange = async (index: number, image: fileMetadata.TFileMetadata) => {
  ...
  const handlePublish = (description: string, links: any[], includeInMaterials: boolean) => {
