...
const sampleAssignmentModals: AssignmentModalProps[] = [
  // AwaitingReview, no reply (coach)
  {
    ...
    children: (
      <div className="p-4 bg-base-neutral-800 rounded-medium">
        <p className="text-text-primary">Assignment content with messages and reply panel would go here...</p>
      </div>
    ),
  },
  // AwaitingForLongTime, with reply (coach)
  {
    ...
    description: 'Write a comprehensive essay about portrait photography techniques.',
    files: [
      {
        id: '2',
    ...
    children: (
      <div className="flex flex-col gap-4">
        <div className="p-4 bg-base-neutral-800 rounded-medium">
          <p className="text-text-primary mb-2">Student submission:</p>
          <p className="text-text-secondary text-sm">Here is my essay on portrait photography...</p>
        </div>
        <div className="p-4 bg-base-neutral-700 rounded-medium">
          <p className="text-text-primary">Reply panel would be here for coaches to provide feedback...</p>
        </div>
      </div>
    ),
  },
  // Passed, with reply (student view)
  {
    ...
    description: 'Practice composition techniques using the rule of thirds and leading lines.',
    files: [],
    links: [
      {
        linkId: 1001,
    ...
    children: (
      <div className="flex flex-col gap-4">
        <div className="p-4 bg-green-900/20 border border-green-700 rounded-medium">
          <p className="text-green-400 font-semibold mb-2">✓ Assignment Passed</p>
          <p className="text-text-secondary text-sm">Great work on the composition! Your use of leading lines is excellent.</p>
        </div>
        <div className="p-4 bg-base-neutral-800 rounded-medium">
          <p className="text-text-primary">Conversation history and feedback would appear here...</p>
        </div>
      </div>
    ),
  },
  // Additional assignment for better sorting examples
  {
    ...
    children: (
      <div className="p-4 bg-base-neutral-800 rounded-medium">
        <p className="text-text-primary">This assignment is waiting for student submission...</p>
      </div>
    ),
  },
  // Another assignment with different module/lesson
  {
    ...
    description: 'Master studio lighting setups for professional portraits.',
    files: [generateFile()],
    links: [generateLink()],
    course: {
    ...
    children: (
      <div className="flex flex-col gap-4">
        <div className="p-4 bg-green-900/20 border border-green-700 rounded-medium">
          <p className="text-green-400 font-semibold mb-2">✓ Assignment Completed</p>
          <p className="text-text-secondary text-sm">Excellent work on the lighting setup! Your studio portraits show great mastery of professional techniques.</p>
        </div>
      </div>
    ),
  },
...
export const Default: Story = {
  args: {
    ...
    availableCourses: ['Storybook Champions', 'Photography Masterclass', 'Portrait Photography Course', 'Photography Basics', 'Professional Photography'],
    availableModules: ['Module 1', 'Module 2', 'Module 3', 'Module 4'],
    availableLessons: ['Lesson 1', 'Lesson 2', 'Lesson 3', 'Lesson 4', 'Lesson 5', 'Lesson 6', 'Lesson 7'],
  },
};
