...
export const WithoutDownload: Story = {
  args: {
    ...
    onClickGroup: () => alert('Group clicked without download'),
    onClickView: () => alert('View clicked without download'),
    // No onDownloadAll prop - download button should not appear
    availableStatuses: ['AwaitingReview', 'AwaitingForLongTime', 'Passed'],
  },
};
