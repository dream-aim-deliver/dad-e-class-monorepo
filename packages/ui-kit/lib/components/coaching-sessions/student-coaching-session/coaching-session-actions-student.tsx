...
export interface CoachingSessionActionsProps extends isLocalAware {
  status:
    | 'ongoing'
    | 'upcoming-editable'
    | 'upcoming-locked'
...
/**
 * CoachingSessionActions Component
 *
...
export const CoachingSessionActions: React.FC<CoachingSessionActionsProps> = ({
  status,
  hoursLeftToEdit,
  meetingLink,
  hasReview = false,
      ...
      render: () => (
        <div className="flex flex-col gap-1 items-start w-full">
          <Button
            ...
            size="medium"
            className="w-full"
            text={dictionary.components.coachingSessionOverview.joinMeetingText}
          />
          {meetingLink && (
        ...
        <div className="flex flex-col gap-2 w-full">
          <Badge
            ...
            text={`${hoursLeftToEdit} ${
              dictionary.components.coachingSessionOverview.hoursLeftToEditText
            }`}
          />
          <div className="flex gap-[9px] justify-between">
            <Button
              ...
              text={
                dictionary.components.coachingSessionOverview.rescheduleText
              }
            />
            <Button
              ...
              text={dictionary.components.coachingSessionOverview.cancelText}
            />
          </div>
        </div>
      ),
      ...
      render: () => (
        <div className="flex flex-col gap-1 items-start">
          ...
          <p className="text-xs text-text-secondary leading-[100%]">
            {
              dictionary.components.coachingSessionOverview
      ...
      render: () => (
        <div className="flex flex-col gap-2">
          <Badge
            ...
            variant="info"
            size="big"
            text={dictionary.components.coachingSessionOverview.requestSentText}
            hasIconLeft
          ...
          <Button
            ...
            iconLeft={<IconTrashAlt size="5" />}
            text={
              dictionary.components.coachingSessionOverview.cancelRequestText
            }
          />
        </div>
      ),
      ...
      render: () => (
        <div className="flex flex-col gap-2 items-center w-full">
          <div className="flex justify-between gap-3 w-full">
            <Button
              text={dictionary.components.coachingSessionOverview.declineText}
              variant="secondary"
              hasIconLeft
              className="w-full"
            ...
            <Button
              variant="primary"
              text={dictionary.components.coachingSessionOverview.acceptText}
              hasIconLeft
              className="w-full"
    ...
    canceled: {
      render: () => (
        <Badge
          ...
          text={
            dictionary.components.coachingSessionOverview.sessionCanceledText
          }
          hasIconLeft
          iconLeft={<IconTrashAlt size="5" />}
        />
