...
export const CourseCreator: React.FC<CourseCreatorProps> = ({
  ...
  const createdByText =
    dictionary.components.coachingSessionOverview.createdByText;
  const studentText = dictionary.components.coachingSessionOverview.studentText;
  const courseText = dictionary.components.coachingSessionOverview.courseText;
  const groupText = dictionary.components.coachingSessionOverview.groupText;
  return (
