...
import type { TProfiles, TPersonalProfile, TProfessionalProfile } from '../../../models/src/profile';

interface ProfileTabsProps {
    initialProfiles: TProfiles;
    onSave?: (profiles: TProfiles) => void;
}

export const ProfileTabs: React.FC<ProfileTabsProps> = ({ initialProfiles, onSave }) => {
    ...
    // Extract profiles
    const personalProfile = initialProfiles[0] as TPersonalProfile;
    const professionalProfile = hasProfessionalProfile ? initialProfiles[1] as TProfessionalProfile : undefined;
