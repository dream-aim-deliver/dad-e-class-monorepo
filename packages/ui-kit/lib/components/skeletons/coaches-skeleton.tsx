...
export function CoachCardListSkeleton({
    ...
    return (
        <CardListLayout className="lg:grid-cols-3 w-full col-span-full">
...
function CoachCardSkeleton() {
    return (
        <div className="flex flex-col bg-card-fill gap-4 text-sm md:text-md border border-card-stroke p-4 rounded-lg text-text-secondary h-[550px] w-full">
            {/* Profile line */}
