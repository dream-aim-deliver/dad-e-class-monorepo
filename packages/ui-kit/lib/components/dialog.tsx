...
export const Dialog: React.FC<DialogProps> = ({ children, open, onOpenChange, defaultOpen = false }) => {
...
export const DialogTrigger: React.FC<DialogTriggerProps> = ({ children, asChild = false, className = "" }) => {
...
export const DialogClose: React.FC<DialogCloseProps> = ({ children, asChild = false, className = "" }) => {
  const { setIsOpen } = useDialog();
