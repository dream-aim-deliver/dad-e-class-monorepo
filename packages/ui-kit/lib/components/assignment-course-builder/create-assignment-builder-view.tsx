 ...
 * @param assignmentId The unique identifier of the assignment (used for link and file operations).
 ...
 * @param onLinkDelete Callback to remove a link. Receives the assignmentId, linkId, and type ('link').
