...
import { DownloadFiles, LinkLessonEdit, LinkLessonPreview, UplaodFileType } from "../course-builder-lesson-component//types";
 ...
 * ```
 */
export type courseElement = DownloadFiles| LinkLessonEdit | LinkLessonPreview |UplaodFileType;
/**
