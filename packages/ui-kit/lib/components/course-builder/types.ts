...
import { AssignmentElement, CoachingElement, QuizElement, ImageElement , ImageGallery, VideoElement, DownloadFilesElement, UploadFilesElement, TempQuizTypeOneElement} from "../course-builder-lesson-component/types";
/**
 ...
 */
export type CourseElement = CoachingElement | QuizElement | TempQuizTypeOneElement | DownloadFilesElement | UploadFilesElement | ImageElement | VideoElement | ImageGallery | AssignmentElement;
