...
import { AccordionElement, CoachingElement, QuizElement, ImageFile , ImageGallery, VideoFile} from "../course-builder-lesson-component/types";
...
export enum CourseElementType {
    ...
    Quiz = 'quiz',
    /** Represents an accordion element */
    Accordion = 'accordion',
 ...
 */
export type courseElement = CoachingElement | QuizElement | ImageFile | VideoFile | ImageGallery  | AccordionElement;
