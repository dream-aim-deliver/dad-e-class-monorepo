...
import { CoachingElement, ImageFile, ImageGallery, VideoFile} from "../course-builder-lesson-component/types";
 ...
 */
export type courseElement = CoachingElement| ImageFile | VideoFile | ImageGallery ;
