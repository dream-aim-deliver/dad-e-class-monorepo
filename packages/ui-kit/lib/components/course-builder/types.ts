...
import { AssignmentElement, CoachingElement, QuizElement, ImageElement , ImageGallery, VideoElement, DownloadFilesElement, UploadsFilesElement} from "../course-builder-lesson-component/types";
/**
 ...
 */
export type CourseElement = CoachingElement | QuizElement | DownloadFilesElement | UploadsFilesElement | ImageElement | VideoElement | ImageGallery | AssignmentElement;
