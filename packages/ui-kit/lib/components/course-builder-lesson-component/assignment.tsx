...
import { AssignmentBuilderViewTypes, CreateAssignmentBuilderViewTypes } from "./types";
...
function DesignerComponent({
    ...
    return (
        <DesignerLayout
            ...
            title={dictionary.components.assignment.assignmentBuilder.assignmentText}
        ...
        >
            <CreateAssignmentBuilderView
                {...(elementInstance as CreateAssignmentBuilderViewTypes)}
                locale={locale}
            />
        </DesignerLayout>
    );
