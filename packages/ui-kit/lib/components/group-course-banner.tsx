  ...
  locale,
    ...
    <div className="flex flex-row w-full p-3 items-center gap-16 bg-base-neutral-800 rounded-small border border-base-neutral-700">
        <div className="flex flex-col gap-3 justify-start items-left">
            <p className="text-sm text-text-primary font-important"> {dictionary.components.groupCourseBanner.takenAlsoBy} </p>
        ...
        <div className="flex-1 flex justify-end">
            <Button
                size="medium"
                variant="primary"
                text={dictionary.components.groupCourseBanner.groupWorkspaceButton}
