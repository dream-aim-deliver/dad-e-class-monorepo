...
// Quiz Type Four Validation
export const getValidationError: ElementValidator = (props) => {
    const { elementInstance, dictionary } = props;

    if (elementInstance.type !== CourseElementType.QuizTypeFour)
        return dictionary.components.quiz.quizTypeFour.validationErrors
            .wrongElementType;
...
const QuizTypeFour: FC<QuizTypeFourProps> = ({
    ...
    const handleAddPair = () => {
        ...
        handleChange({
            ...
            images: [
                ...element.images,
                { correctLetter: nextLetter, imageFile: null },
            ],
        });
    };
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-3 w-full">
                    {element.labels.map((lbl, idx) => (
                        <div
                            key={idx}
                            className="flex gap-2 md:flex-row flex-col items-stretch w-full"
                        >
                            {/* Label and TextArea */}
                            ...
                            <div className="w-full flex flex-col md:flex-row gap-2 justify-center items-center">
                                <div className="flex md:w-1/2 h-full w-[100%]">
                                    <TextAreaInput
                                        ...
                                        setValue={(v) =>
                                            handleLabelDescriptionChange(idx, v)
                                        }
