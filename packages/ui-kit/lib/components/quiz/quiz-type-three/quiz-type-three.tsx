...
export const getValidationError: ElementValidator = (props) => {
    ...
    if (elementInstance.type !== CourseElementType.QuizTypeThree)
        return dictionary.components.quiz.quizTypeThree.validationErrors
            .wrongElementType;
...
const QuizTypeThree: FC<QuizTypeThreeProps> = ({
    ...
    return (
        <div className="flex flex-col gap-[13px] w-full">
            ...
            {/* error */}
            {uploadError && (
                <Banner style="error" title={uploadError} className="w-full" />
            )}
            {/* Choices Section */}
                    ...
                    <React.Fragment key={index}>
                        <div className="flex-1 min-w-0 flex flex-col gap-4 items-start">
                            ...
                            <InputField
                                className="w-full"
                                inputText={
                                    dictionary.components.quiz.quizTypeThree
