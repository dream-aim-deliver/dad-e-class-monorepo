  ...
  getDictionary: () => ({
    components: {
      removeModal: {
        ...
        errorMessageLesson: 'An error occurred while deleting the lesson.',
        errorMessageModule: 'An error occurred while deleting the module.',
        errorMessageCoach: 'An error occurred while removing the coach.',
        closeButton: 'Close',
        backButton: 'Back',
        deleteButton: 'Delete',
        coach: 'Coach',
...
vi.mock('../lib/components/icons/icon-error', () => ({
  IconError: ({
    ...
    classNames?: string;
  }) => <span data-testid="icon-error" className={classNames}>Error</span>,
}));
...
vi.mock('../lib/components/icons/icon-loader-spinner', () => ({
  IconLoaderSpinner: ({
    ...
    classNames?: string;
  }) => <div data-testid="spinner" className={classNames}>Loading...</div>,
}));
...
describe('RemoveModal', () => {
  ...
  it('renders the deleted state for module', () => {
    render(<RemoveModal {...baseProps} variant="module" deleted={true} />);
    expect(screen.getByText('Module has been deleted.')).toBeInTheDocument();
